...
PyObject* marching_cubes_func(PyObject* lower, PyObject* upper,
    int numx, int numy, int numz, PyObject* pyfunc, double isovalue, double truncation)
{
    ...
    // Marching cubes.
    mc::marching_cubes(lower_, upper_, numx, numy, numz, pyfunc_to_cfunc, isovalue, truncation, vertices, polygons);
...
PyObject* marching_cubes(PyArrayObject* arr, double isovalue, double truncation)
{
    ...
    // Marching cubes.
    mc::marching_cubes(lower, upper, numx, numy, numz, pyarray_to_cfunc, isovalue, truncation,
                        vertices, polygons);
